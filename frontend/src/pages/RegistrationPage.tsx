...
import { ArrowLeft, ArrowRight, Building2, MapPin, CreditCard, CheckCircle2, Info, AlertCircle, Loader, Check, Sparkles, Zap, Shield } from 'lucide-react';
import { toast } from 'sonner';
import { onboardingApi, type OnboardingRequest } from '../lib/api';
import { AntigravityBackground } from '../components/AntigravityBackground';

const BG = '#020617'; const BORDER = 'rgba(255,255,255,0.08)'; const CYAN = '#22d3ee';
const TEXT = '#f1f5f9'; const DIM = '#64748b';

const defaultData: OnboardingRequest = { schoolName: '', schoolCode: '', boardAffiliation: 'CBSE', contactEmail: '', contactPhone: '', addressLine: '', city: '', state: '', country: 'India', postalCode: '' };
