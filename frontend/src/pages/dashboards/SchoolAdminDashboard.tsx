...
import { Users, BookOpen, Calendar, CreditCard, Home, FileText, Clock, ClipboardList, Loader, AlertTriangle, GraduationCap, Bus, Library, MessageSquare, BarChart2, Sparkles } from 'lucide-react';
...
export default function SchoolAdminDashboard() {
  ...
  const quickActions = [
    { label: 'Mark Attendance', icon: Calendar, color: '#22d3ee', path: '/attendance' },
