  ...
  persist(
    (set) => ({
      ...
      logout: () => {
        ...
        set({ 
          session: { userId: null, role: null, email: null, fullName: null, schoolId: null, schoolCode: null, schoolName: null, tenantId: null, isPremium: false, planCode: 'FREE', featureCodes: [], transportScopes: [], token: null },
