...
VALUES (
    ...
    49.99,
    500,
    'ONBOARDING,AUTH,SCHOOL_OPS,ATTENDANCE,TRANSPORT_BASE,TRANSPORT_LIVE_TRACKING,TRANSPORT_NOTIFICATIONS',
    CURRENT_TIMESTAMP
) ON CONFLICT (plan_code) DO UPDATE SET 
    plan_name = EXCLUDED.plan_name,
    description = EXCLUDED.description,
...
VALUES (
    ...
    'PREMIUM',
    'PREMIUM',
    'Full access with real-time AI, finance, and premium transport intelligence.',
    199.99,
    10000,
    '*', 
    CURRENT_TIMESTAMP
