...
public class PlatformSettingsService {
    ...
    public PlatformSettingsResponse getSettings() {
        PlatformSettingsEntity entity = repository.findAll().stream().findFirst()
    ...
    private PlatformSettingsEntity initializeDefaultSettings() {
        PlatformSettingsEntity entity = new PlatformSettingsEntity();
        entity.setSettingsId(java.util.UUID.fromString("00000000-0000-0000-0000-000000000000"));
