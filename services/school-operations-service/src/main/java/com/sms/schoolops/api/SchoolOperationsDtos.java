...
public class SchoolOperationsDtos {
    ...
    public record SchoolUserRequest(@NotNull UUID tenantId, @NotNull UUID schoolId, @NotBlank String schoolCode, @NotBlank String schoolName, @NotBlank String fullName, @Email @NotBlank String email, @NotBlank String roleName, String accessKey) {}
    ...
    public record StudentAdmissionResponse(UUID admissionId, UUID schoolId, UUID studentUserId, String admissionNo, LocalDate admittedOn, LocalDate dateOfBirth, String guardianName, String guardianPhone, String address, String previousSchool, StudentStatus admissionStatus, Instant createdAt) {}
