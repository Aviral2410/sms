...
public interface AttendanceRecordRepository extends JpaRepository<AttendanceRecordEntity, UUID> {
    ...
    List<AttendanceRecordEntity> findBySchoolIdAndUserIdAndAttendanceDateBetweenOrderByAttendanceDateAscCreatedAtAsc(UUID schoolId, UUID userId, LocalDate fromDate, LocalDate toDate);
    List<AttendanceRecordEntity> findBySchoolIdAndClassIdAndAttendanceDateBetweenOrderByAttendanceDateAscCreatedAtAsc(UUID schoolId, UUID classId, LocalDate fromDate, LocalDate toDate);
    List<AttendanceRecordEntity> findBySessionIdOrderByCreatedAtAsc(UUID sessionId);
    List<AttendanceRecordEntity> findBySchoolIdAndSessionId(UUID schoolId, UUID sessionId);
}
